...
public class ATM {
    ...
    ATM(int numberOfBanknote20, int numberOfBanknote50, int numberOfBanknote100){
        ...
        balance += (20 * numberOfBanknote20 +
                50 * numberOfBanknote50 + 100 * numberOfBanknote100);
    }

    void addMoney(int numberOfBanknote20,
                  int numberOfBanknote50, int numberOfBanknote100) {
    ...
    boolean withdrawMoney(int withdrawnMoney) {
        if (withdrawnMoney > balance) {
            ...
            do {
                if (withdrawnMoney / 100 < numberOfBanknote100 &&
                        withdrawnMoney / 100 != 0) {
                ...
                if (withdrawnMoney / 50 < numberOfBanknote50 &&
                        withdrawnMoney / 50 != 0) {
                ...
                if (withdrawnMoney / 20 < numberOfBanknote20 &&
                        withdrawnMoney / 20 != 0) {
